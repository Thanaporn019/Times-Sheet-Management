...
class JobType extends React.Component {
    ...
    render() {
        ...
        return ( < >
            ...
            for = "txtJobType"
            className = "title-field" > Job Type < span style = {
                { color: 'red' }
            } > * < /span></label > < /div> <
            input type = "text"
            ...
            for = "txtCode"
            className = "title-field" > Code < span style = {
                { color: 'red' }
            } > * < /span></label > < /div> <
            input type = "text"
            class = "form-control col-3"
            ...
            style = {
                { width: 250 }
            } > < span className = "btn-icon" > < IoAddOutline / > < /span> <span className="btn-txt-icon">Create Job Type</span > < /button> < /
            Link > <
            /div>
