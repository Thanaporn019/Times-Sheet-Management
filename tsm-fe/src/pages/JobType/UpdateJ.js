        ...
        <div className="App">
          <div id="boxType" className="container-box-content">
            <div className="row ">
              ...
              <p><Navbar.Brand href="#Job Type" style={{ marginLeft: "140px" }}>JobType</Navbar.Brand>/ Update JobType</p>
              </div>

              <div className="col-12 box-search">
                <div className="row">
                  <div className="col-12">
                    <p style={{ color: "#696969" }}>Update JobType</p>
                  </div>
                      ...
                      <form>
                        ...
                        <div className="row form-group">
                          ...
                          <div className="col-12">
                            ...
                            <Button variant="primary" onClick={this.openModal}>UPDATE
                     </Button>
                  </div>
